...
export const schema = z.object({
  ...
  port: z.coerce.number<number>("Port is required").min(0),
  username: z.string().optional(),
  password: z.string().optional(),
  max_audio_streams: z.coerce.number<number>().min(0, "Max audio streams is required").optional(),
  max_video_streams: z.coerce.number<number>().min(0, "Max video streams is required").optional(),
  ...
  qualifyFrequency: z.coerce.number<number>().min(1).optional(),
