...
export class AGIChannel extends events.EventEmitter {
  ...
  CallCompletionCancel = (args: string) =>
    this.Exec("CallCompletionCancel", args);
  CallCompletionRequest = (args: string) =>
    this.Exec("CallCompletionRequest", args);
  ...
  StopMixMonitor = (args: string | undefined) =>
    this.Exec("StopMixMonitor", args);
  ...
  VoiceMailMain = (args: string | undefined) =>
    this.Exec("VoiceMailMain", args);
  ...
  WaitForSilence = (args: string | undefined) =>
    this.Exec("WaitForSilence", args);
